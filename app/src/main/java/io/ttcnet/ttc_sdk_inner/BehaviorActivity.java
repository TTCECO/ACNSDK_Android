...
public class BehaviorActivity extends AppCompatActivity {
    ...
    private TextView tvTtcGetRate;
    private TextView tvTtcCreateOrder;
    private TextView tvTtcGetOrder;
    private TextView tvOpenWallet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTtcCreateOrder = findViewById(R.id.order_create_order);
        tvTtcGetOrder = findViewById(R.id.order_get_order);
